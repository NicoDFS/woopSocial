const main = async () => {
    ...
    const contract = await contractFactory.deploy(
        ...
        StartTransitionVerifier = "Contract Address",
        ProcessAttestationsVerifier = "Contract Address",
        UserStateTransitionVerifier = "Contract Address",
        ReputationVerifier = "Contract Address",
        UserSignUpVerifier = "Contract Address",
        60,
        70,
        80,
        90
